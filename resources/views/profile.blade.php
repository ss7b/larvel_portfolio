    ...
    <div class="row">
        ...
        <div class="col-lg-4 order-lg-2">
            ...
            <div class="card shadow mb-4">
                <div class="card-profile-image mt-4" style="position: relative">
                    <form method="POST" action="{{ route('profile.update') }}" autocomplete="off">
                        @method("PUT")
                        @csrf
                        <img src="{{  Auth::user()->image }}" alt="" class="rounded-circle avatar avatar font-weight-bold" style=" height: 180px; width: 180px;">
                        <label for="image" >
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('profile.update') }}" autocomplete="off">
                        ...
                        <h6 class="heading-small text-muted mb-4">معلومات الادمن</h6>

                        <div class="pl-lg-4">
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group focused">
                                        <label class="form-control-label" for="name">الاسم<span class="small text-danger">*</span></label>
